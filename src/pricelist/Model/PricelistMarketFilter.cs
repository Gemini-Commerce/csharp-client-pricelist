...
namespace pricelist.Model
{
    ...
    /// </summary>
    [DataContract(Name = "pricelistMarketFilter")]
    public partial class PricelistMarketFilter : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricelistMarketFilter" /> class.
        /// </summary>
        /// <param name="markets">markets.</param>
        /// <param name="condition">condition.</param>
        public PricelistMarketFilter(List<string> markets = default(List<string>), PricelistFilterCondition? condition = default(PricelistFilterCondition?))
        {
