...
namespace pricelist.Model
{
    ...
    /// </summary>
    [DataContract(Name = "pricelistMoney")]
    public partial class PricelistMoney : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricelistMoney" /> class.
        /// </summary>
        ...
        public PricelistMoney(string units = default(string), int micros = default(int))
        {
            this.Units = units;
            this.Micros = micros;
        }
