...
namespace pricelist.Model
{
    ...
    /// </summary>
    [DataContract(Name = "pricelistSetPriceListItemPrice")]
    public partial class PricelistSetPriceListItemPrice : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricelistSetPriceListItemPrice" /> class.
        /// </summary>
        ...
        public PricelistSetPriceListItemPrice(PricelistMoney price = default(PricelistMoney), bool isEnabled = default(bool), DateTime startAt = default(DateTime), DateTime endAt = default(DateTime), long order = default(long), PricelistMoney basePrice = default(PricelistMoney))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PricelistSetPriceListItemPrice {\n");
